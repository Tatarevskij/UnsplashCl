...
import com.example.unsplashcl.databinding.FragmentCollectionDetailsBinding
...
class CollectionDetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.loadPhotosByCollectionId(photosPagedAdapter, args.collectionId)
    ...
    private fun onItemClick(item: Photo) {
        ...
        findNavController().navigate(R.id.action_collectionDetailsFragment_to_photoDetailsFragment)
    }
